...
parser.add_argument(
    ...
    default=[0.1225],
    metavar='V',
    help='VARIANCE of the helper prior actions. The thesis states the prior '
         'standard deviation sigma_h = 0.35, i.e. variance 0.1225; measured '
         'helper success rate at this value is ~50%% (a working but '
         'low-performance prior).')

parser.add_argument(
    '--demo-type',
    type=str,
    default='uav',
    help="helper prior type: 'uav' (SenAvo-Pri) or 'uav_wrong' (Naive-Pri)")
